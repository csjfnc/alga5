...
import com.algamoney5.curso.service.LancamentoService;
...
public class LancamentoResource {
	...
	public Page<ResumoLancamento> resumir(LancamentoFilter lancamentoFilter, Pageable pageable){
		return lancamentoService.resumirService(lancamentoFilter, pageable); 
	}
	
	@PostMapping
	@PreAuthorize("hasAuthority('ROLE_CADASTRAR_LANCAMENTO') and #oauth2.hasScope('write')")
	public ResponseEntity<Lancamento> criar(@Valid @RequestBody Lancamento lancamento, HttpServletResponse response){
		Lancamento lancamentoSalvo = lancamentoService.criarService(lancamento);
	...
	public ResponseEntity<Lancamento> atualizar(@PathVariable Long codigo, @Valid @RequestBody Lancamento lancamento){
		Lancamento lancamentoSalva = lancamentoService.atualizarService(codigo, lancamento);
	...
	public void remover(@PathVariable Long codigo){
		lancamentoService.removerService(codigo);
	}
}
